...
(defun find-node (location &key temp-name cell-name real-name first-nodes)
  ...
  (loop for node in first-nodes
	...
	do (when real-name
	     ...
	     (setf (gethash real-name (NODE-HASH-TABLE)) node
...
(defvar *neurolucida-soma-diameter* 0.10)
...
(defun read-neurolucida-file (filename &optional cell-name)
  "For processing Neurolucida format anatomy files. For more information, see sys/neurolucida.lisp."
...
;; PARSE-NEUROLUCIDA-LINE Ignores lines unless they start with "["
