...
;;;
;;; By un-commenting the impossible2 precondition, the user can force a lowering
;;; of expectations (goal-erosion transmutation). This is now an obsolete comment.
;;;
...
;				  (THREAT-AT WEAPONS-SMUGGLING1 korea-south)
...
;                                  (IS-READY F15-C-SQUADRON)
                      ...
                      (GOAL (AND (airport-secure-at korea-south airport2)))))