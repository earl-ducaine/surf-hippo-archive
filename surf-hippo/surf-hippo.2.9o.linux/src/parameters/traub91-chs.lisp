...
(channel-type-def
 '(na-trb91-fit
   ...
   (QTEN . 1)          	 
   (ion-permeabilities . ((NA 1.0)))
   (v-particles . ((nam-trb91-fit 2)(nah-trb91-fit 1)))))
...
(particle-type-def
 `(nam-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'nam-trb91-alpha-function)
   (beta-function . ,#'nam-trb91-beta-function)))
...
(particle-type-def
 `(nah-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'nah-trb91-alpha-function)
   (beta-function . ,#'nah-trb91-beta-function)))
...
(channel-type-def
 '(ca-trb91-fit
   ...
   (ion-permeabilities . ((CA 1.0)))
   (conc-int-type-params . ((ca-in-traub91 (1 1))))
   (v-particles . ((cas-trb91-fit 2)(car-trb91-fit 1)))))    
...
(particle-type-def
 `(cas-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'cas-trb91-alpha-function)    
   (beta-function . ,#'cas-trb91-beta-function)))
...
(particle-type-def
 `(car-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'car-trb91-alpha-function)    
   (beta-function . ,#'car-trb91-beta-function)))
...
(particle-type-def
 `(kdrn-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'kdrn-trb91-alpha-function)    
   (beta-function . ,#'kdrn-trb91-beta-function)))
...
;; KCC-TRB91-FIT not a very good fit..
(channel-type-def
 '(kc-trb91-fit
   (gbar-density . 100.0)	          
   (e-rev . -75.0)
...
(particle-type-def
 `(kcc-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'kcc-trb91-alpha-function)    
   (beta-function . ,#'kcc-trb91-beta-function)))
...
(channel-type-def
 '(ka-trb91-fit
   ...
   (QTEN . 1)          	 
   (reference-temp . 22.0) 	
   (v-particles . ((kaa-trb91-fit 1)(kab-trb91-fit 1)))))   
...
(particle-type-def
 `(kaa-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'kaa-trb91-alpha-function)    
   (beta-function . ,#'kaa-trb91-beta-function)))
...
(particle-type-def
 `(kab-trb91
   (class . :hh)
   (QTEN . 1)          	 
   (alpha-function . ,#'kab-trb91-alpha-function)    
   (beta-function . ,#'kab-trb91-beta-function)))
