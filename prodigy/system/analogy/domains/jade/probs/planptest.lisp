...
(objects-are palawan mindanao portugal romania philippines country)
                       ...
                       (objects-are 25th-infantry-division-light 6th-id infantry)
...
;(airport-secure-at |<location.23>| |<airport.24>|)
;(exists ((|<location.26>| location) ) (is-deployed security-police-a |<location.26>|))

(safe-us-personnel philippines)

;(exists ((|<location.29>| location) (|<ground-force-module.28>| ground-force-module)) (is-deployed |<ground-force-module.28>| |<location.29>|))
;(exists ((|<location.31>| location)) (is-deployed military-police-a |<location.31>|))

(is-sovereign  philippines 11-meu-soc)

;(exists ((|<fighter-aircraft.35>| fighter-aircraft)) (air-defended philippines |<fighter-aircraft.35>|))
;(exists ((|<carrier-air-wing.37>| carrier-air-wing) (|<country.36>| country)) (air-blockaded |<country.36>| |<carrier-air-wing.37>|))
;(exists ((|<carrier-battle-group.39>| carrier-battle-group) (|<country.38>| country)) (naval-blockaded |<country.38>| |<carrier-battle-group.39>|))
)
