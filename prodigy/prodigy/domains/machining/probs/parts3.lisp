;;; 3 parts of different type of material: use a different hardness
;;; wheel. 
;;; As wheel is coarse-grit, op is rough-grind.
;;; Both size and surface-cond goals are achieved by the same
;;; operator. 
...
(setf (current-problem)
	...
	(objects-are part1 part2 part3 PART))
       (state
	(and 
	 (always-true)
