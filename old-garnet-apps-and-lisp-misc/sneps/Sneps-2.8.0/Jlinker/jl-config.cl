...
;; $Id: jl-config.cl,v 1.1.1.1 2011/05/24 17:59:35 mwk3 Exp $
...
(setf javatools.jlinker:*jlinker-java-home* "/usr/bin")
;;(setf javatools.jlinker:*jni-library* "jre/bin/client/jvm.dll")
