...
;wrt planp state, malayasian-brigade --> nkorean-brigade and changed location of town-center1

(setf (current-problem)
      (create-problem (name Jack3)
		       ...
		       (object-is terrorism1 terrorism) ;jack3 Specific [cox 8apr98]
...
(object-is safe-haven2 evac-location) ;Jack3 specific [cox 8apr98]
(object-is johnston-atoll location)
(object-is conus location)
(objects-are alice mike sorin manuela NONCOMBATANTS)
(objects-are us-population1 us-population2 portuguese-population
	     portuguese-population2 ;Jack3 specific [cox 8apr98]
	     romanian-population POPULATION)

(object-is nkorean-brigade enemy-ground-unit)
...
(is-active f117-squadron) ;jack3 specific
(is-active 18th-wing)
(is-active 374-aw)
(is-active 3-wing)
(is-active 354-wing)
...
(is-available f16-b-squadron day-19) ;jack3 specific
(is-available a10a-c-squadron day-19) ;jack3 specific
...
(loc-at-p portuguese-population2 sri-lanka) ;Jack3 specific [cox 8apr98]
...
(citizen-of PORTUGAL portuguese-population2) ;Jack3 specific [cox 8apr98]
...
;Commented out below for jack3 specifically [cox 8apr98]
...
(loc-at TOWN-CENTER1 korea-south) 
(is-deployed nkorean-brigade town-center1) 
...
(is-active f16-a-squadron) ;jack3 specific
(is-active f16-b-squadron) ;jack3 specific
(is-active f16-c-squadron) ;jack3 specific
...
(is-deployed 25th-id-division-ready-brigade BOSNIA-AND-HERZEGOVINA)
(is-suppressed terrorism1 BOSNIA-AND-HERZEGOVINA)
(IS-DEPLOYED a10a-c-squadron KOREA-SOUTH)
(IS-DEPLOYED f117-squadron KOREA-SOUTH)
(IS-DEPLOYED f16-b-squadron KOREA-SOUTH)
(AIR-BLOCKADED KOREA-SOUTH Carrier-air-wing-9)
(AIR-DEFENDED KOREA-SOUTH 18th-wing)

(IS-SOVEREIGN KOREA-SOUTH 11-meu-soc)

;(is-evacuated SRI-LANKA)
;(removed-from-loc 11-meu-soc SRI-LANKA portuguese-population2) replaces goal below
;(LOC-AT-P portuguese-population2 japan)
(AIRPORT-SECURE-AT SRI-LANKA airport1)
