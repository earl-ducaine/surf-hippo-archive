...
;                                  (is-ready division-ready-brigade))
                      ...
                      (goal 
		       (and
			(is-deployed f16-c-squadron sri-lanka)
			(airport-secure-at sri-lanka airport1)
			(is-deployed infantry-battalion-a sri-lanka)
			(is-deployed security-police-b sri-lanka)
			(is-deployed hawka sri-lanka)
			)
			    ;(and 
