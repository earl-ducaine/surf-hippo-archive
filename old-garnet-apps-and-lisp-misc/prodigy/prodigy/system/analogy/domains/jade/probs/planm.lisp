...
(setf (current-problem)
      (create-problem (name PlanM)
		       ...
		       (object-is colombo-airport airport)  ; planm specific
...
(object-is sri-lanka-province country)  ; planm specific
...
(object-is iii-mef  meu-soc) ;planm specific. Not really a meu-soc, rather a
			     ;marine expeditionary force. but this is needed to
			     ;make matching past cases work for now.
...
;(part-of f-15c 18th-wing)
;(part-of f-15d 18th-wing)
;(part-of kc-135 18th-wing)
;(part-of e3-b 18th-wing)
;(part-of e3-c 18th-wing)
...
(is-active USS-Essex)
(is-active C141-A)
(is-active 6th-id) ;Planm specific
;(is-active 25th-id) ;commented out so 6th id used in planm
;(is-active bd1)
(is-active 11-meu-soc)
(is-active iii-mef)  ; planm specific
(is-active Carrier-air-wing-9)
(is-active security-police-a)
(is-active military-police-a)
(is-active hawka)
;commented out next 3 so 6th id used in planm
;(is-active 25th-infantry-division-light)
...
(is-available 6th-id day-19)
(is-available 11-meu-soc day-19)
(is-available iii-mef day-19)  ; planm specific
...
(is-ready 6th-id) ;PlanM specific
(loc-at 6th-id schofield-barracks) ; day-19
...
(province-of sri-lanka  sri-lanka-province)  ; planm specific
...
(near airport1 safe-haven)  ; planm specific. changed from Puerto-Princessa to airport1.
(loc-at-p mike mindanao)
(loc-at-p alice mindanao)
(loc-at-p manuela mindanao)
(loc-at-p sorin mindanao)
(loc-at-p us-population1 sri-lanka-province)  ; planm specific. Changed from palawan to sri-lanka-province
(loc-at-p us-population1 sri-lanka)  ; planm specific. Added
(loc-at-p us-population2 sri-lanka-province)  ; planm specific
(loc-at-p us-population2 sri-lanka) ; planm specific. Added
(loc-at-p portuguese-population  sri-lanka-province)  ; planm specific
(loc-at-p portuguese-population  sri-lanka) ; planm specific. Added
(loc-at-p romanian-population sri-lanka-province)  ; planm specific
(loc-at-p romanian-population sri-lanka) ; planm specific. Added
...
(member-of PORTUGAL designated-foreign-national-countries)
                                  ...
                                  (loc-at colombo-airport sri-lanka)  ; planm specific
                                  (loc-at airport1 sri-lanka-province)  ; planm specific. Changed from sri-lanka to sri-lanka-province

(loc-at safe-haven sri-lanka-province)  ; planm specific. Changed from palawan to sri-lanka-province
...
(is-usable airport6)
                                  ...
                                  (is-usable colombo-airport) ; planm specific
                                  ...
                                  (is-ready iii-mef) ; planm specific
                                  (is-ready 11-meu-soc)
...
(is-target weapons-mass-dest-c)
				  ...
				  (loc-at Sabiran-tbm-support-facility Sabiran)
                      ...
                      (goal 
(and 
 (is-deployed a10a-c-squadron korea-south)
 (is-deployed f16-c-squadron korea-south)
 (is-mission-supported sri-lanka 45th-support-group)
 (is-medically-assisted sri-lanka 45th-support-group)
 (is-evacuated iii-mef sri-lanka)
; (removed-from-loc iii-mef sri-lanka us-population1)
; (removed-from-loc iii-mef sri-lanka us-population2)
; (removed-from-loc iii-mef sri-lanka portuguese-population)
; (removed-from-loc iii-mef sri-lanka romanian-population)
 (is-neo-supported sri-lanka)
 (is-sovereign sri-lanka 11-meu-soc)
 (air-defended sri-lanka 18th-wing)
 (air-blockaded sri-lanka carrier-air-wing-9)
 (naval-blockaded sri-lanka uss-essex-cvg)
 )
;(and;;FM TFS
...
;)
;(and (IS-DEPLOYED a10a-a-squadron KOREA-SOUTH)
;(IS-DEPLOYED F117-squadron KOREA-SOUTH)
;                                 (IS-DEPLOYED f16-b-squadron KOREA-SOUTH)
;                                 (IS-MISSION-SUPPORTED SRI-LANKA 45th-support-group)
;	       )
