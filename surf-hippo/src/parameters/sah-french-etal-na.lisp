...
(defvar nam-sgg-ss
  (sequence-to-float-array (loop for voltage from -100 to 50 by 0.1 collect
...
;; fig 11
#|
(let ((user-stop-time 200) *overlay-all-plots* (*ACCOMODATE-ALL-OVERLAYS* t))
...
(let ((user-stop-time 300) *overlay-all-plots* (*ACCOMODATE-ALL-OVERLAYS* t))
