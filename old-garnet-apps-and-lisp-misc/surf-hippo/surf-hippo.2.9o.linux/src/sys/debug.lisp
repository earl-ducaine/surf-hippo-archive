...
(defvar *debug-all-iterations*  nil "When t, prints out the node voltages at every iteration.")
...
(defun profile-all ()
  (profile::unprofile)
  (profile:profile eval-fixed-node-voltages
		   eval-all-conc-ints
		   eval-all-conc-particles
		   ;; ---------
