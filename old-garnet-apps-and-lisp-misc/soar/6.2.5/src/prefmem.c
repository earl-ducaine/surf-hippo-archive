/*
 * $Id: prefmem.c,v 1.4 1994/11/23 16:40:34 rempel Exp $
 * $Log: prefmem.c,v $
 * Revision 1.4  1994/11/23  16:40:34  rempel
 * for 6.2.4
 *
 * Revision 1.3  1994/08/23  10:36:22  portelli
 * For 6.2.4
 *
 * Revision 1.2  1993/11/21  17:03:38  soarhack
 * 6.1.1 checkin
 *
 * Revision 1.1  1993/06/17  20:48:19  jtraub
 * Released
 *
 * Revision 0.1  1993/06/17  20:22:32  jtraub
 * 6.1_checkin
 *
 * Revision 9.1  1993/05/10  20:31:11  jtraub
 * Initial checkin.
 *
 */
...
void deallocate_preference (preference *pref) {
  ...
  if (pref->reference_count != 0) {   /* --- sanity check --- */
    print ("Internal Error: Deallocating preference with ref. count != 0\n");
