...
(defun module-loadable-path (module &optional source-if-newer)
  ...
  (print (module-bin-path module))
  (print "module-src-path:")
  (print (module-src-path module))
...
(defun write-Makefile-for-system (system)
  ...
  (let* ((up-pathname (lisp:make-pathname :directory '(:relative :up)))
	 (default-pathname
