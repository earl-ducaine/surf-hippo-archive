...
(setf (getf cl-user::*herald-items* :garnet)
      `("    Garnet Version " ,Garnet-Version-Number))

(setf (getf cl-user::*herald-items* :surf-hippo)
...
(if (> (length Surf-Hippo-Version-Comment) 0)
    (setf
     (getf cl-user::*herald-items* :surf-hippo-comment)
     `("               " ,Surf-Hippo-Version-Comment)))


(defvar load-cmucl-fixes-p nil)
