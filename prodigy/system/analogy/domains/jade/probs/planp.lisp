...
(is-target weapons-mass-dest-c)
				  ...
				  (loc-at Sabiran-tbm-support-facility Sabiran)
                      ...
                      (goal 
;(AND (REMOVED-FROM-LOC 11-MEU-SOC PHILIPPINES US-POPULATION1)
;     (REMOVED-FROM-LOC 11-MEU-SOC PHILIPPINES US-POPULATION2)
;     (REMOVED-FROM-LOC 11-MEU-SOC PHILIPPINES PORTUGUESE-POPULATION)
;     (IS-EVACUATED 11-MEU-SOC PHILIPPINES)
;     (IS-PROTECTED-AND-DEFENDED PHILIPPINES) (IS-DEFENDED PHILIPPINES)
;     (IS-PROTECTED PHILIPPINES) (LAW-ABIDING PHILIPPINES)
...
;     (AIR-DEFENDED PHILIPPINES 18th-wing)
;     (AIR-BLOCKADED PHILIPPINES CARRIER-AIR-WING-9)
;     (NAVAL-BLOCKADED PHILIPPINES USS-ESSEX-CVG))
...
;                        (is-protected philippines )
;                        (is-sovereign mindanao 11-meu-soc))
;(is-secure fort-magsaysay) 
;   (~ (loc-at sorin palawan))
;                                  (is-deployed c141-a palawan)
;                                  (airport-secure-at palawan Puerto-Princessa)
;(is-secure safe-haven)
				 
;				 (achieved-air-superiority Sabiran)
;				 (protected infantry-battalion-a Sabiran)
;				 (neutralized-wmd-capability Sabiran)
			     )))
