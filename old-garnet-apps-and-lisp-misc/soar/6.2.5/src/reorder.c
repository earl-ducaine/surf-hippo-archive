/*
 * $Id: reorder.c,v 1.7 1994/11/23 16:40:34 rempel Exp $
 * $Log: reorder.c,v $
 * Revision 1.7  1994/11/23  16:40:34  rempel
 * for 6.2.4
 *
 * Revision 1.6  1994/08/23  10:37:28  portelli
 * For 6.2.4
 *
 * Revision 1.5  1994/07/01  15:58:00  portelli
 * For 6.2.2
 *
 * Revision 1.4  1994/06/09  17:34:07  portelli
 * For 6.2.1
 *
 * Revision 1.3  94/06/08  22:19:50  portelli
 * For 6.2.1
 * 
 * Revision 1.2  93/11/21  17:09:39  soarhack
 * 6.1.1 checkin
 * 
 * Revision 1.1  1993/06/17  20:48:21  jtraub
 * Released
 *
 * Revision 0.1  1993/06/17  20:23:50  jtraub
 * 6.1_checkin
 *
 * Revision 9.1  1993/05/10  20:33:01  jtraub
 * initial checkin
 *
 */

/* ======================================================================
              Reorder routines for Soar 6
====================================================================== */
...
void remove_isa_state_tests_for_non_roots(condition **lhs_top, condition **lhs_bottom, list *roots)
{
  ...
  for (cond = *lhs_top; cond != NIL; cond = cond->next) {
    if ((cond->type == POSITIVE_CONDITION) &&
      ...
      cond->data.tests.id_test = copy_test_removing_goal_impasse_tests(cond->data.tests.id_test,&a,&b);
  }
}
#endif
...
bool reorder_lhs (condition **lhs_top, condition **lhs_bottom,
  ...
  /* MVP 6-8-94 - NNPSCM fix provided by Bob */
  if (!roots) {
    condition *cond;
